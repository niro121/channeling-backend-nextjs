...
import type { PatientExcessReportRow } from '@/types/reports';
...
export const patientExcessReportColumns: ColumnDef<PatientExcessReportRow>[] = [
  {
  ...
  },
  {
    ...
    header: 'Excess',
    cell: ({ row }) => (
      <span className="tabular-nums font-semibold text-teal-800 whitespace-nowrap">
        {formatLkr(row.original.excessAmount)}
      </span>
    ),
  },
  {
