...
/** Default from = today 00:00, to = today 23:59 (same as channeling Doctor Leave Report). */
export function getDefaultDateTimeRange(): { from: string; to: string } {
  const now = new Date();
      ...
      <div
        className={
          singleRow
            ...
            : 'flex flex-col sm:flex-row flex-wrap items-center gap-2'
        }
      >
