...
import { getPublicAgencyBalance } from "@/services/public/agencies.service"
 ...
 * Live PAYABLE balance + allowedCreditLimit. Requires Bearer token.
 */
...
export async function GET(
  ...
  const result = await getPublicAgencyBalance(agencyId ?? "")
