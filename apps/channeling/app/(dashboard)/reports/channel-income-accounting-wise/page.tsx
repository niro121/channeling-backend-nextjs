...
import ChannelIncomeAccountingWiseReportContent from './channel-income-accounting-wise-report-content';
import { getReportFilterOptions } from '@/services/reference/report-filter-options.service';

export const dynamic = 'force-dynamic';

export default async function ChannelIncomeAccountingWiseReportPage() {
  ...
  return <ChannelIncomeAccountingWiseReportContent locationOptions={locationOptions} currentUserName={currentUserName} />;
}
