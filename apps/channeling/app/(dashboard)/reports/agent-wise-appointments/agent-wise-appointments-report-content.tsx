                ...
                pdfSummaryItems={
                  reportMeta
                    ? toBrandedPdfSummaryItems([
                        {
                          label: 'Period',
                          value: formatReportRangeLabel(reportMeta.from, reportMeta.to),
                          fullWidth: true,
                        },
                        { label: 'Branch', value: reportMeta.branchLabel },
                        { label: 'Agent', value: reportMeta.agentLabel },
                        {
                          label: 'Report Type',
                          value: reportMeta.reportType === 'detail' ? 'Detail' : 'Summary',
                        },
                        { label: 'Institution', value: reportMeta.institutionLabel },
                        { label: 'Department', value: reportMeta.departmentLabel },
