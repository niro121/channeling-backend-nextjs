...
const METHOD_OPTIONS = [
  ...
  { value: String(RECEIPT_METHOD.BANK_DEPOSIT), label: RECEIPT_METHOD_NAMES[RECEIPT_METHOD.BANK_DEPOSIT] },
  { value: String(RECEIPT_METHOD.BANK_WITHDRAW), label: RECEIPT_METHOD_NAMES[RECEIPT_METHOD.BANK_WITHDRAW] },
]
