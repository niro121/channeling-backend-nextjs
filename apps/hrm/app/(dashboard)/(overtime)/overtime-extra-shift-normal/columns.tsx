...
import ExtraShiftNormalRecordActions from './record-actions';
import { ExtraShiftNormalStaffCell } from './staff-cell';
import type { ExtraShiftNormalRecord } from './sample-data';

type ExtraShiftNormalColumnsOptions = {
  onEdit?: (record: ExtraShiftNormalRecord) => void;
};

export function createExtraShiftNormalColumns(
  options?: ExtraShiftNormalColumnsOptions
): ColumnDef<ExtraShiftNormalRecord>[] {
  return [
    {
    ...
    },
    {
      ...
      header: 'Staff',
      cell: ({ row }) => <ExtraShiftNormalStaffCell record={row.original} />
    },
    {
      accessorKey: 'roster',
      header: 'Roster',
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <ExtraShiftNormalRecordActions row={row} onEdit={options?.onEdit} />
      ),
      enableHiding: false
    }
  ];
