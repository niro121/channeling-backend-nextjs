...
export default function SectionManageRosterList() {
  ...
  const handleAdd = () => {
    ...
    toast({
      ...
      description: 'Enter the roster details in the form on the right, then click Save.'
    });
    requestAnimationFrame(() => {
      document
        .getElementById('manage-roster-detail-form')
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 text-xs text-muted-foreground">
                          {record.assignedStaffCount} staff · {record.code}
                        </p>
                      </div>
                    </div>
                  </button>
