...
import { Button, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@archmage/ui';

interface CommonDataTablePaginationProps<TData> {
  table: Table<TData>;
...
export function CommonDataTablePagination<TData>({
  table,
  onLimitChange,
  onPageChange,
  leftActions
}: CommonDataTablePaginationProps<TData>) {
  const setFirstPage = () => {
