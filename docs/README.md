...
| [Staff Attendance Architecture](../apps/hrm/docs/STAFF_ATTENDANCE_ARCHITECTURE.md) | RFID / finger-scan attendance architecture, ingest API, day rules, Duty Roster confirm sync, phased implementation checklist |

## App-specific docs

| App | Location |
|-----|----------|
| HRM | `apps/hrm/docs/` — `PERMISSION_FLOW.md`, `HRM_DEVELOPMENT_GUIDELINES.md`, `LEAVE_MANAGER_GUIDE.md`, `OVERTIME_MANAGER_GUIDE.md`, `ROSTER_SHIFTS_MANAGER_GUIDE.md`, [`STAFF_ATTENDANCE_ARCHITECTURE.md`](../apps/hrm/docs/STAFF_ATTENDANCE_ARCHITECTURE.md); HR Admin entry point: [`docs/HR_ADMINISTRATION_GUIDE.md`](../apps/hrm/docs/HR_ADMINISTRATION_GUIDE.md) |
