...
export async function settleBookingService(
  ...
  if (input.auto_discount_type && booking.session) {
    const sessionForDiscount: Session = {
      ...
      amountLocal: booking.session.amountLocal ?? undefined,
      amountForeign: booking.session.amountForeign ?? undefined,
      status: booking.session.status,
      appointmentNo: booking.session.appointmentNo,
      isScan: booking.session.isScan,
      doctorId: booking.session.doctorId ?? undefined,
      departmentId: booking.session.departmentId ?? undefined,
      locationId: booking.session.locationId ?? undefined,
      roomId: booking.session.roomId ?? undefined,
      location: booking.session.location ?? undefined,
      room: booking.session.room ?? undefined,
      doctor: booking.session.doctor ?? undefined,
      ...
      remarks: booking.session.remarks ?? undefined,
