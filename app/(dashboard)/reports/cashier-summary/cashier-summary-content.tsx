    ...
    <div className="rounded-md border border-primary/30 bg-primary/5 shadow-sm px-3 py-2.5">
      ...
      <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-0.5">
          ...
          <p className="text-[11px] font-semibold leading-tight">{meta.reportName}</p>
        </div>
        ...
        <div className="space-y-0.5 sm:col-span-2 lg:col-span-1">
          <p className="text-[10px] uppercase tracking-wide text-muted-foreground">Included shifts</p>
          <p className="text-[11px] leading-tight font-medium">
